...
type ImportWorkspaceProps = {
  ...
  onAddApproved: (weeklyStart?: string, weeklyEnd?: string) => void;
...
export default function ImportWorkspace({ isAuthenticated, isScanning, inputRef, fileName, message, candidates, onChooseFile, onAddApproved, canUndoLastImport, onUndoLastImport, onUpdateCandidate, onDiscard }: ImportWorkspaceProps) {
