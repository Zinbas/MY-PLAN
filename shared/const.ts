...
/** Browser sessions are individually revocable and intentionally shorter than the former one-year JWT. */
...
export type OAuthState = { redirectUri: string; nonce?: string; nativeVerifierHash?: string };
